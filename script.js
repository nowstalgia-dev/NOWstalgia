...
// Audio for slider (free retro sound)
const slideSound = new Audio('https://www.myinstants.com/media/sounds/8-bit-jump.mp3'); // 8-bit jump sound
...
const nostalgiaData = {
    ...
    1995: {
        ...
        image: "https://images.pexels.com/photos/3945683/pexels-photo-3945683.jpeg露
...
function updateContent() {
    ...
    yearInfo.innerHTML = yearData[currentCategory] || userMemories[year] || "No vibes yet—add your own!"; // Use innerHTML for links
    yearImage.src = yearData.image || '';
    yearImage.style.display = yearData.image ? 'block' : 'none';
}

slider.addEventListener('input', () => {
    slideSound.play(); // Play sound on slide
    updateContent();
});
